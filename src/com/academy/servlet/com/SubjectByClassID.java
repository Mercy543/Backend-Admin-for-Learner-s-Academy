...
/**
 * Servlet implementation class SubjectByClassID
 */
@WebServlet("/subject-byclassid")
public class SubjectByClassID extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SubjectByClassID() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		response.sendRedirect("find-subjectbyclassid.html");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<table border='1'><tr><th>Class Description</th><th>Subject Description</th><th>Subject Code</th><th>Unit</th></tr>");
		...
		try {
			...
			if (conn != null) {
				...
				String query ="call find_subjectbyclassid(?)"; 														
